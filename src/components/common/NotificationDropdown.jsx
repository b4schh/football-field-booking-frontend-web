 ...
 * Component chung để hiển thị thông báo cho Customer, Owner và Admin
 * Được tích hợp SSE để nhận thông báo real-time
 */
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <HiOutlineBell size={20} className="text-gray-700" />
