...
/**
 * CreatePermissionModal Component
 * Modal tạo quyền mới
 */
export default function CreatePermissionModal({ isOpen, onClose, onSubmit, isLoading }) {
  ...
  const validate = () => {
    ...
    if (!formData.permissionKey.trim()) {
      ...
      newErrors.permissionKey = "Permission key chỉ được chứa chữ, số, dấu chấm, gạch dưới và gạch ngang";
    }
